  ...
  <div class="mx-auto max-w-md px-4 py-8">
    ...
    <form @submit.prevent="onSubmit" class="space-y-4">
      <div>
        ...
        <input v-model="name" type="text" required class="w-full rounded-md border px-3 py-2 bg-slate-900" />
      </div>
      ...
      <div class="flex items-center justify-between">
        <button class="rounded-md bg-cyan-500 px-4 py-2 text-sm font-semibold text-white">Crear cuenta</button>
